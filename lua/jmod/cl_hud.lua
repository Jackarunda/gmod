...
hook.Add("RenderScreenspaceEffects","JMOD_SCREENSPACE",function()
	...
	if not LocalPlayer().activeBlindness then LocalPlayer().activeBlindness = 0 end -- Because of run order, the check in cl_init to prevent an annoying error doesn't run when it is needed
