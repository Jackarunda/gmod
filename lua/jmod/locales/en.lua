JMod.Locales["en"] = {
	...
	["hint oil derrick"] = "the pumpjack must be on solid ground above a liquid resource reserve",
	["hint ground drill"] = "the drill must be on solid ground above a solid resource deposit",
