JMod.Locales["en-PT"]={
    ...
    ["hint bind walk"] = "Ensure you have bound the Walk bottle, use command 'bind alt +walk'",
    ["hint unpackage"] = "WALK+USE to loot the chest",
    ["hint sticky"] = "Hold Use, put near yonder wall and release to stick object",
    ["hint arm"] = "Hold Walk and press Use to arm",
    ["hint trigger"] = "Say *trigger* in chat or command jmod_ez_trigger to detonate",
    ["hint launch"] = "Say *launch* in chat or command jmod_ez_launch to fire one rocket",
    ["hint bombdrop"] = "Say *bomb* in chat or command jmod_ez_bombdrop to deweld bomb",
    ["hint mine friends"] = "Set your mateys with command jmod_friends; mateys won't trigger your intelligent booby-traps",
    ["hint prime"] = "Hold Walk and press Use to pick up and hand-bomb",
    ["hint grenade"] = "Hand-bombs can be thrown great lengths, right click to do a short toss",
    ["hint grenade drop"] = "Caution, dropped hand-bombs are still burnin!",
    ["hint arm boundingmine"] = "Hold Walk and press Use when near soft terrain to burrow and arm",
    ["hint arm powderkeg"] = "Hold Walk and press Use to toggle pouring black powder",
    ["hint arm satchelcharge"] = "Hold Walk and press Use on the blasting machine to detonate",
    ["hint arm navalmine"] = "Drop in water after arming to anchor to the seabed",
    ["hint frag sleeve"] = "Hold Sprint while priming to toggle fragmentation sleeve",
    ...
    ["hint ent_jack_gmod_ezherocket"] = "HE Rockets accelerate and explodes in a small radius",
    ["hint ent_jack_gmod_ezheatrocket"] = "HEAT Rockets accelerate and does a lot of damage in a small cone",
    ...
    ["hint ent_jack_gmod_eznuke"] = "Micro Nukes explode in an extremely large radius and spreads radiation",
    ["hint ent_jack_gmod_ezboundingmine"] = "Bounding Mines bury underground and shoot shrapnel when enemies approach",
    ["hint ent_jack_gmod_ezminimore"] = "Claymores spray shrapnel in a cone when enemies approach its front",
    ["hint ent_jack_gmod_eznavalmine"] = "Naval Mines attach themselves underwater and detonate on contact",
    ["hint ent_jack_gmod_eznuke_small"] = "Nano Nukes explode in a large radius and spreads radiation",
    ...
    ["hint ent_jack_gmod_ezsticknade"] = "Stick Grenades can be thrown very far, and has an optional frag sleeve",
    ...
    ["hint ent_jack_gmod_ezfieldhospital"] = "can be used to heal and cure radiation sickness",
    ...
    ["hint ent_jack_gmod_ezfuel"] = "Fuel is used too craft the Jeep (for now)",
