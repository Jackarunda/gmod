...
net.Receive("JMod_EZtoolbox", function()
	...
	-- enable func
	StandardSelectionMenu('crafting', "EZ Tool Box", Buildables, Kit, function(name, info, ply, ent) return JMod.HaveResourcesToPerformTask(ent:GetPos(), 150, info.craftingReqs, ent, LocallyAvailableResources) end, function(name, info, ply, ent)
		-- click func
...
net.Receive("JMod_EZworkbench", function()
	...
	-- enable func
	StandardSelectionMenu('crafting', "EZ Work Bench", Buildables, Bench, function(name, info, ply, ent) return JMod.HaveResourcesToPerformTask(ent:GetPos(), 200, info.craftingReqs, ent, LocallyAvailableResources) end, function(name, info, ply, ent)
		-- click func
