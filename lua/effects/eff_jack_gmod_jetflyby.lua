function EFFECT:Init(data)
	self.IsChrimsas = JMod.GetHoliday() == "Christmas"
	self.LifeTime = 1.75
	self.DieTime = CurTime() + self.LifeTime
	self.Plane = ClientsideModel((self.IsChrimsas and "models/xqm/coastertrain1.mdl") or "models/xqm/jetbody3_s2.mdl")
...
function EFFECT:Render()
	...
	Ang:RotateAroundAxis(Ang:Up(), (self.IsChrimsas and 180) or -90)
