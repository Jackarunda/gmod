...
local Hints={
	...
	["arm"]="ALT+E to arm.",
	["detpack det"]="Chat *trigger* or use concommand jmod_ez_trigger.",
	...
	["detpack combo"]="Detpacks can unweld and destroy props. Multiple detpacks create one more powerful explosion.",
	["afh"]="Press E to enter and get healed.",
	...
	["eat"]="ALT+E to consume rations.",
	["friends"]="Use concommand jmod_friends to specify allies.",
	["radio comm"]="Radio needs to see sky to function.",
	["upgrade"]="Use a Build Kit to upgrade.",
	...
	["jmod hands move"]="Punching also can move you (jump boost/climbing).",
	["unpackage"]="Double tap ALT+E to unpackage.",
	["crafting"]="Set resources near workbench in order to use them.",
	["building"]="Stand near resources in order to use the.m",
	["generator"]="Generator consumes fuel and creates power. ALT+E to start/stop and E to take batteries.",
