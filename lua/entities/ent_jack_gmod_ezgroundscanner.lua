...
ENT.PhysMatDetectionWhitelist = {"metal", "metalvehicle", "metalpanel", "metal_barrel", "floating_metal_barrel", "grenade", "canister", "weapon", "slipperymetal", "jalopy", "roller", "metalvent", "computer", "solidmetal"}
...
if SERVER then
    ...
    function ENT:FinishScan()
        ...
        if #Results > 0 then
            ...
            table.sort(Results, function(a, b) return a.siz > b.siz end)
        else
