...
ENT.PrintName = "EZ Well"
ENT.Category = "JMod - EZ Machines"
ENT.Spawnable = false
ENT.AdminOnly = false
ENT.Base = "ent_jack_gmod_ezmachine_base"
---
-- "Water well" (https://skfb.ly/6YpvX) by Ethian74 is licensed under Creative Commons Attribution (http://creativecommons.org/licenses/by/4.0/).
...
---
ENT.WhitelistedResources = {JMod.EZ_RESOURCE_TYPES.WATER}
---
