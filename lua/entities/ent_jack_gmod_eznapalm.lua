...
if (SERVER) then
	function ENT:Initialize()
		self.Ptype=6
		self.TypeInfo={"NAPALM", "Napalm", Model("models/weapons/ar2_grenade.mdl"), {""}, "models/mat_jack_gmod_brightwhite", Color(255, 255, 255), Angle(0, 0, 0), 600, .5, .5, .5, 5, "eff_jack_gmod_fire", false, true, false}
		-----
	...
	function ENT:Think()
		...
		if (self.Stuck) then
			...
			if ((self.StuckEnt:IsNPC() or self.StuckEnt.IsDrGNextbot) and not (self.StuckEnt:Health() > 0)) then
				self:Detonate()
...
elseif (CLIENT) then
	function ENT:Initialize()
		self.Ptype=6
		self.TypeInfo={"NAPALM", "Napalm", Model("models/weapons/ar2_grenade.mdl"), {""}, "models/mat_jack_gmod_brightwhite", Color(255, 255, 255), Angle(0, 0, 0), 1200, .5, .5, .5, 2, "eff_jack_gmod_fire", false, true, false}
