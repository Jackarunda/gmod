...
if(SERVER)then
	function ENT:Initialize()
		...
		for i=1,10 do -- some bits and pieces cobbled together from the gnome, should work as a band aid since im flippin stupid.
			...
			local NewPos=SelfPos+Dir*50 -- generate random spot within ~50 units, check to make sure it is not within map geometry.
			local Tr=util.QuickTrace(NewPos+Vector(0,0,30),Vector(0,0,-300),{self})
