...
SWEP.Animations = {
    ...
    ["reload"] = {
        ...
        SoundTable = {
            ...
            {
                s = "snds_jack_gmod/ez_weapons/smg/out.wav",
                t = .2,
                v = 65
            },
            {
            ...
            {
                s = "snds_jack_gmod/ez_weapons/smg/in.wav",
                t = 1.6,
                v = 65
            },
            {
    ...
    ["reload_empty"] = {
        ...
        SoundTable = {
            ...
            {
                s = "snds_jack_gmod/ez_weapons/smg/pull.wav",
                t = 2.15,
                v = 65
            },
            {
                s = "snds_jack_gmod/ez_weapons/smg/release.wav",
                t = 2.35,
                v = 65
            },
            {
