...
SWEP.Animations = {
    ...
    ["ready"] = {
        Source = "draw_first",
		SoundTable = {
			{s = JMod.GunHandlingSounds.draw.handgun, t = 0, v=60, p=110},
